                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo base_url('index.php/employee/userpic/profilepicupdate');?>" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                <?php if ($employeediteles->profilepic) { ?>
                                  <img src="<?php echo base_url($employeediteles->profilepic);?>"style="height:180px; width:180px;">
                                <?php } ?>
